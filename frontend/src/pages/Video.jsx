...
const Video = () => {
  ...
  const [isViewCounted, setIsViewCounted] = useState(false);
        ...
        const incrViewCount = async () => {
            ...
            await axios.put(`https://eclipx-six.vercel.app//api/videos/view/${currentVideo?._id}`,
              {
  ...
  useEffect(()=>{
    ...
    const fetchData = async () =>{
      ...
      try{
        ...
        const videoRes = await axios.get(`https://eclipx-six.vercel.app//api/videos/find/${path}`);
        const channelRes = await axios.get(`https://eclipx-six.vercel.app//api/users/find/${videoRes.data.userId}`);
  ...
  const handleLike = async () => {
    try {
      await axios.put(
        `https://eclipx-six.vercel.app//api/users/like/${currentVideo?._id}`,
        {},
        { withCredentials: true } 
      );
  ...
  const handleDislike = async () => {
    ...
    try {
      ...
      await axios.put(
        `https://eclipx-six.vercel.app//api/users/dislike/${currentVideo._id}`,
        {},
        { withCredentials: true } 
      );
  ...
  const handleSub = async () =>{
    ...
    try {
            ...
            if (currentUser.subscribedUsers.includes(channel._id)){
                ...
                await axios.put(
                  `https://eclipx-six.vercel.app//api/users/unsub/${channel._id}`,
                    {},
                    { withCredentials: true } 
                  );
                  ...
                  await axios.put(
                  `https://eclipx-six.vercel.app//api/users/sub/${channel._id}`,
                    {},
                    { withCredentials: true } 
                  );
  ...
  const handleSave = async () => {
      ...
      try {
        ...
        if (currentUser.savedVideos.includes(currentVideo._id)) {
            ...
            const res = await axios.put(`https://eclipx-six.vercel.app//api/users/unsavevideo/${currentVideo._id}`);
            ...
            const res = await axios.put(`https://eclipx-six.vercel.app//api/users/savevideo/${currentVideo._id}`);
